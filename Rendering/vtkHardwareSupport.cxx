...
vtkCxxSetObjectMacro(vtkHardwareSupport, ExtensionManager, vtkExtensionManager);

// ----------------------------------------------------------------------------
vtkHardwareSupport::vtkHardwareSupport()
{
...
// ----------------------------------------------------------------------------
int vtkHardwareSupport::GetNumberOfFixedTextureUnits()
{
...
// program.
int vtkHardwareSupport::GetNumberOfTextureUnits()
{
  int result=1;
  ...
  if(supports_shaders)
    {
    result = this->MaxCombinedTextureImageUnits();
    }
  return result;
}
...
// ----------------------------------------------------------------------------
bool vtkHardwareSupport::GetSupportsMultiTexturing()
{
  if ( ! vtkgl::MultiTexCoord2d || ! vtkgl::ActiveTexture )
    {
...
//-----------------------------------------------------------------------------
void vtkHardwareSupport::PrintSelf(ostream& os, vtkIndent indent)
{
  os << indent << this->ExtensionManager << endl;
  this->Superclass::PrintSelf(os,indent);
}

bool vtkHardwareSupport::ExtensionManagerSet()
{
